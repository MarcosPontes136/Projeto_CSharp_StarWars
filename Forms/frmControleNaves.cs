...
using Projeto_CShap_Com_SQL.Extensions;
using System;
...
namespace Projeto_CShap_Com_SQL.Forms
{
    public partial class frmControleNaves : Form
    {
        ...
        private void FormControleNaves_Load(object sender, EventArgs e)
        {
        ...
        private void formControleNaves_FormClosing(object sender, FormClosingEventArgs e)
        {
            _naveDao?.Dispose();
            _pilotoDao?.Dispose();
            Dispose();
